...
fn main() {
    ...
    let incl_range_vs_const = |x, b| match x {
        0..=5 if b => 0,
        7 => 1,
        3 => 2,
        _ => 3,
    ...
    let excl_range_vs_const = |x, b| match x {
        0..5 if b => 0,
        7 => 1,
        3 => 2,
        _ => 3,
    ...
    let const_vs_incl_range = |x, b| match x {
        3 if b => 0,
        5..=7 => 2,
        1..=4 => 1,
        _ => 3,
    ...
    let const_vs_excl_range = |x, b| match x {
        3 if b => 0,
        5..7 => 2,
        1..4 => 1,
        _ => 3,
